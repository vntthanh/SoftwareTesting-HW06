...
## Pre-Postman reviewed result

- Final output: `test-cases/b-discount-coupons.csv`
- AI review artifact: `review/pool-b/candidate-api-tests.csv`
- Final count: 74 distinct candidates (67 AI-generated plus 7 human-added; target count 35 met)
- Final category counts: CONTRACT 17; DOMAIN 48; STATE 0; SECURITY 9
- AI-generated subset: 67 cases — CONTRACT 15; DOMAIN 44; STATE 0; SECURITY 8
- Human-added subset: 7 cases (`API-068`–`API-074`) — CONTRACT 2; DOMAIN 4; SECURITY 1
- AI audit disposition: all 67 retained AI-generated cases are explicitly `VALID`, each with a case-level reason in the review artifact. Earlier incomplete generations were corrected and deduplicated before this reviewed snapshot; no rejected AI record remains in the final subset.
